...
return [
    ...
    */
    ...
    'mailers' => [
        ...
        'smtp' => [
            'transport' => 'smtp',
            // smtp = STARTTLS (587), smtps = SSL (465). Avoid env value "null".
            ...
            // Short timeout so Render does not 502 while Gmail SMTP hangs
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Inbox that receives portfolio contact form submissions.
    |
    */
